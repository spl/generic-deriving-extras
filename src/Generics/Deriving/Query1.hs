...
queryDndefault :: (Generic c, Query' (Rep c) a) => Q c a b
queryDndefault e p f = queryDn' e p f . from

queryDnapply :: Q a a b
queryDnapply _ _ f = f 

queryDnempty :: Q c a b
queryDnempty e _ _ _ = e
