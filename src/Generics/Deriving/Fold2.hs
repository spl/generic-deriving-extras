...
instance Fold p a => Fold' (K1 i a) p where
...
instance (Fold p a, Fold' g p) => Fold' (M1 i c (K1 j a) :*: g) p where
...
foldK1 :: Fold p a => Algebra p r -> a -> Either a (r a)
